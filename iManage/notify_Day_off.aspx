<%@ Page Title="" Language="C#" MasterPageFile="~/mpStandard.Master" AutoEventWireup="true" CodeBehind="notify_Day_off.aspx.cs" Inherits="iManage.notify_Day_off" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <h1 class="text-center text-primary mt-5 mb-5">Number of day off</h1>
    <div class="d-flex justify-content-center">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="DAYS_REQUIREMENT_WORKING" HeaderText="Day requirement working" />
